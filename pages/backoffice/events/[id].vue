...
const fetchData = async () => {
  ...
  if (fetchedData.error || fetchedTags.error) {
    error.value = fetchData || fetchedTags;
  } else {
            ...
            <div class="mt-10 grid grid-cols-3 gap-x-16 gap-y-5">
              ...
              <!-- <div class="">
                ...
                <div class="flex gap-3 my-4">
                  <input type="date" class="b2 border px-4 py-2 bg-lavender-gray/5 shadow-inner rounded-lg" required :value="useFormatDateTime(event.ticket_start_date, 'ISOdate')">
                  <input type="time" class="b2 border px-4 py-2 bg-lavender-gray/5 shadow-inner rounded-lg" required :value="event.ticket_start_date ? useFormatDateTime(event.ticket_start_date, 'time') : ''">
                </div>
              </div>
              <div class="">
                <p class="b1">Ticket End Date</p>
                <div class="flex gap-3 my-4">
                  <input type="date" class="b2 border px-4 py-2 bg-lavender-gray/5 shadow-inner rounded-lg" required :value="useFormatDateTime(event.ticket_end_date, 'ISOdate')">
                  <input type="time" class="b2 border px-4 py-2 bg-lavender-gray/5 shadow-inner rounded-lg" required :value="event.ticket_end_date ? useFormatDateTime(event.ticket_end_date, 'time') : ''">
                </div>
              </div> -->
